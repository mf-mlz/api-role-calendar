...
/* Last Day => Count */
const lastIndexDatMonth = sundaysInMonth.length - 1;
const lastDatMonth = sundaysInMonth[lastIndexDatMonth];
const daysUntilEndOfMonth = numberOfDaysInMonth - lastDatMonth;
